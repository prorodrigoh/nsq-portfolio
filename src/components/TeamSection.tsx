...
import { Users, User, GraduationCap, Award } from "lucide-react";
...
export default function TeamSection() {
  ...
  return (
    <section id="team" className="py-16 md:py-24 bg-[#EDF1F8]/50">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold transition-all ${
                activeCategory === cat.id
                  ? "bg-[#081E3F] text-white shadow-md"
          ...
          {displayedCategories.map((category) => (
            <div key={category.id}>
              <div className="flex items-center gap-3 mb-8 border-b border-[#D8E2EE] pb-3">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-[#081E3F] font-heading">
                  ...
                  >
                    <div>
                      ...
                      <div className="relative h-64 w-full bg-[#15213F]/5 overflow-hidden border-b border-[#D8E2EE]">
                        ...
                        {/* FIU fellowship badge indicator */}
                      ...
                      {/* Card Info */}
                      <div className="p-5">
                        <h4 className="text-lg font-bold text-[#081E3F] mb-1 font-heading group-hover:text-[#476FD6] transition-colors">
                          {member.name}
                        </h4>
                        ...
                        {member.researchFocus && (
                          <p className="text-xs text-[#15213F]/85 leading-relaxed bg-[#EDF1F8]/60 p-3 rounded-xl border border-[#D8E2EE]/60">
                            {member.researchFocus}
                          </p>
                        )}
                      </div>
